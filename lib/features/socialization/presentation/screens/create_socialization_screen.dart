...
class CreateSocializationScreen extends StatefulWidget {
  const CreateSocializationScreen({super.key});

  @override
  State<CreateSocializationScreen> createState() =>
      _CreateSocializationScreenState();
}

class _CreateSocializationScreenState extends State<CreateSocializationScreen> {
  ...
  Widget build(BuildContext context) {
    final saving = context.watch<SocializationNotifier>().isSaving;

    return Scaffold(
      appBar: AppBar(title: const Text('Buat Sosialisasi')),
      body: ListView(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              labelText: 'Isi',
              hintText: 'Tulis tautan dengan https:// agar bisa diketuk',
