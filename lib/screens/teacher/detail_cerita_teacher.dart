...
class DetailCeritaTeacherScreen extends StatefulWidget {
  final int ceritaId;

  const DetailCeritaTeacherScreen({super.key, required this.ceritaId});

  @override
  State<DetailCeritaTeacherScreen> createState() =>
      _DetailCeritaTeacherScreenState();
}

class _DetailCeritaTeacherScreenState extends State<DetailCeritaTeacherScreen> {
  ...
  Widget _buildCeritaContent() {
    ...
    final formattedDate =
        DateFormat('EEEE, d MMMM yyyy, HH:mm').format(createdAt);
  ...
  Widget _buildTanggapanCard(Map<String, dynamic> tanggapan) {
    // ... UI for comment card, similar to student's view ...
